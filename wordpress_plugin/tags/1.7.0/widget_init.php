...
Description: The Crypto Converter Widget — is a magic and easy-to-use with beautiful UI real-time web tool to conversion cryptocurrencies FOR ANY WEBSITES FREE. Users can choose from available ≈170 fiat currencies and ≈1,656 crypto.
Version: 1.7.0
...
class CCW_crypto_converter_widget
{
    ...
    public function CCW_shortcode($attr)
    {
        ...
        return $output.'></crypto-converter-widget>'
            ...
            .(($signature) ? 'Source: <a href="https://currencyrate.today/" rel="noopener" target="_blank">CurrencyRate.Today</a>' : '')
